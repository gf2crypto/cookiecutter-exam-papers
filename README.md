# cookiecutter-exam-papers


The repository contains `cookiecutter` ([more details](https://cookiecutter.readthedocs.io/en/latest/)) template for LaTeX examination papers project.
...
4. Go to this directory and run the command from the console:
   ```bash
   cookiecutter https://github.com/gf2crypto/cookiecutter-exam-papers.git
   ```
5. Input parameters:
